...
import static de.jetwick.solrplugin.TWordDelimiterFilter.*;

/**
 *
 */
public class TWordDelimiterIterator {
     ...
     */
    TWordDelimiterIterator(byte[] charTypeTable, boolean splitOnCaseChange, boolean splitOnNumerics, boolean stemEnglishPossessive) {
